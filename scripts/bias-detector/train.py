...
DATASET_NAME = "ciphertext/vijil-bias-detection-eeoc-v2"
HUB_MODEL_ID = "ciphertext/vijil-bias-detector-v2"
MAX_LENGTH = 512
NUM_EPOCHS = 3
BATCH_SIZE = 32
LEARNING_RATE = 2e-5
...
print(f"Sample labels: {tokenized['train']['labels'][:5]}")
...
training_args = TrainingArguments(
    output_dir="vijil-bias-detector-v2",
